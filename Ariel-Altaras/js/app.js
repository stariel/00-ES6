...
function displayPics(){
  ...
  // When const is used, the letiable rando is scoped to the function only. The console log is outside of the function and the letiable rando is now undefined outside of the function.
  console.log(viewed)
